...
>>>>>>> ef0dbbe (Added  hold_equilibrium_in_reactor.py script to test if the model can hold the system in equilibrium and corected minor details)
...
<<<<<<< HEAD
    ...
    evaluator.analyze_and_plot_transition(ensemble_model, data_processor=HDF5Processor(encoder=DinoEncoder()), frame_0=frame_0, frame_1=frame_1, a0=a0, save_path=save_path)
=======
