...
def main():
    ...
    for step_size in step_size_list:
        ...
        for seq_i in sequence_indices:
            ...
            evaluator = Evaluator()
            evaluator.plot_actions_vs_time_for_sequence(ensemble_model, z_hist_tensor, a_hist_tensor, history=hist, step_size=step_size, a_pos="closer_7", future_steps=steps_ahead, save_path=plot_path)
